...
class RobotDescPub(Node):
    ...
    def __init__(self, args):
        ...
        rclpy.logging.set_logger_level(
            'robot_description_pub', rclpy.logging.LoggingSeverity.ERROR)
...
def main(args=None):
    ...
    robot_description_pub = RobotDescPub(args_without_ros)

    rclpy.spin(robot_description_pub)

    robot_description_pub.destroy_node()
